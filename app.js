...
var myCtrl = myApp.controller('myCtrl', function($scope, $http) {
  ...
  $scope.tokenGetter = function() {
    ...
    // authorization failed
      ...
      window.location.assign('http://eduardrg.github.io/SpotifyPlaylistAnalyzer/index.html');

    // need access token
    } else {
      if (confirm('You must sign in to Spotify to continue.')) {
        var CLIENT_ID = 'fa96e83e7cfd46759a5179a204181039';
        var successURL = 'http://eduardrg.github.io/SpotifyPlaylistAnalyzer/index.html';
